...
app = Flask(__name__)
from config import ZENDESK_DOMAIN, ZENDESK_EMAIL, ZENDESK_TOKEN, GLEAN_API_URL, GLEAN_TOKEN, PS_ID, FSE_ID, FIN_ID # Importa as variáveis de ambiente do arquivo config.py
